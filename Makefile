...
SRC_FILES = \
src/convert/vec2to3.c   src/num/num__1.c        src/vec2/vec2__2.c      src/vec2/vec2__7.c      src/vec3/vec3__5.c \
src/convert/vec3to2.c   src/num/num__2.c        src/vec2/vec2__3.c      src/vec3/vec3__1.c      src/vec3/vec3__6.c \
src/mat3x3/mat3x3__1.c  src/qtn/qtn__1.c        src/vec2/vec2__4.c      src/vec3/vec3__2.c      src/vec3/vec3__7.c \
src/mat3x3/mat3x3__2.c  src/qtn/qtn__2.c        src/vec2/vec2__5.c      src/vec3/vec3__3.c		src/convert/vec3_to_qtn.c\
src/mat3x3/mat3x3__3.c  src/vec2/vec2__1.c      src/vec2/vec2__6.c      src/vec3/vec3__4.c		src/convert/qtn_to_vec3.c \
